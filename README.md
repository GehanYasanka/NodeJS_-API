...
අපේ views ඔක්කොම අපි හදන්නේ අපි කලින් හද ගත්තු views කියන folder එකේ එකේ අපි හද ගන්න ඕනේ student.handlebars කියල file එකක් එකේ ඇතුලේ මේ code එක ගහන්න ඕනේ
					...
					28.</html>
						...
						*හරි අපි දැන් table data දන්නා මේ table data එකක් කියන්නේ variable එකක ඒ කියන්නේ this.IndexNo කියන්නේ අපේ Mysql data table එක row name එකක් ඒ වගේ අනිත් ඒවත් හදල තියෙනව ඒ ඒ database row වලට අදාල(18-21 line)
